    ...
    <footer className="bg-[#0F172A] text-gray-400 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Accesorios, ropa y juguetes para tu mascota. Porque ellos se merecen lo mejor.
            </p>
            <div className="flex gap-3 mt-4">
              <a href="https://instagram.com/jaguastore_py" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://facebook.com/jaguastore_py" target="_blank" rel="noopener noreferrer"
                className="text-gray-400 hover:text-[#F5C518] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Categorías */}
          <div>
            <h3 className="text-white font-bold mb-4 text-sm uppercase tracking-wider">Categorías</h3>
            <ul className="space-y-2 text-sm">
              {['Ropa', 'Juguetes', 'Camas', 'Platos', 'Correas', 'Collares', 'Accesorios'].map(cat => (
                <li key={cat}>
                  <Link href={`/categoria/${cat.toLowerCase()}`}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <span>📍</span>
                <span>Campos Cervera esq. Mac Arthur, Bo. Recoleta, Asunción</span>
              </li>
              <li className="flex items-center gap-2">
                <span>⏰</span>
                <span>L-V: 12 a 19hs · S: 9 a 12hs</span>
              </li>
              <li className="flex items-center gap-2">
                <span>🚚</span>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-xs text-gray-600">
          © {new Date().getFullYear()} Jagua Store. Todos los derechos reservados.
        </div>
      </div>
    </footer>
  )
